...
val local_env : entry Env.t ref
val global_env : entry Env.t ref
val offset : int ref
val reset : 'a -> unit
exception DuplicatedLocal of Type.t * string
val register_local_var : Type.t -> Env.key -> unit
exception DuplicatedGlobal of Type.t * string
val register_global_var : Type.t -> Env.key -> unit
val local_var_size : 'a -> int
val get_entry : Env.key -> entry
